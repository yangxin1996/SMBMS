...
<%@include file="/jsp/common/head.jsp"%>
  ...
  <div class="right">
      ...
      <div class="providerAdd">
          <form id="providerForm" name="providerForm" method="post" action="${pageContext.request.contextPath }/provider/modifysave.action" enctype="multipart/form-data">
				<input type="hidden" name="modifyBy" value="${sessionScope.userSession.id}">
			...
			<font color="red"></font>
              ...
              <div>
                  <label for="proDesc">许可证：</label>
                  <input type="file" name="proPic" id="proPic" style="border: transparent;background: #32CD32;color: #fff;font-weight: bold;font-size: 16px;" >                           
              </div>                   
