...
<div class="right">
        ...
        <div class="search">
        	<form method="get" action="${pageContext.request.contextPath }/provider/query.action">
				<span>供应商编码：</span>
        ...
        <table class="providerTable" cellpadding="0" cellspacing="0">
            ...
            <c:forEach var="provider" items="${providerList }" varStatus="status">
				<tr>
					...
					<td>					
					<c:if test="${provider.proFile!=null && provider.proFile!='' }">
						<span><a href="${pageContext.request.contextPath }/provider/download.action?proFile=${provider.proFile }"><img src="${pageContext.request.contextPath }/images/down.png" alt="下载" title="下载"/></a></span>				
					</c:if>
					<c:if test="${provider.proFile==null || provider.proFile=='' }">
						<span><a href="#"><img src="${pageContext.request.contextPath }/images/down.png" alt="下载" title="下载"/></a></span>				
					</c:if>
					</td>	
					<td>
